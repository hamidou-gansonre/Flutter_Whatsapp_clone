...
import 'package:whatsapp_app/features/app/const/message_type_const.dart';
import 'package:whatsapp_app/features/app/global/widgets/dialog_widget.dart';
import 'package:whatsapp_app/features/app/global/widgets/show_image_picked_widget.dart';
import 'package:whatsapp_app/features/app/global/widgets/show_video_picked_widget.dart';
...
import 'package:whatsapp_app/features/call/presentation/pages/pick_up_call_page.dart';
...
import 'package:whatsapp_app/features/chat/presentation/widgets/chat_utils.dart';
import 'package:whatsapp_app/features/chat/presentation/widgets/message_widgets/message_replay_preview_widget.dart';
import 'package:whatsapp_app/features/chat/presentation/widgets/message_widgets/message_replay_type_widget.dart';
import 'package:whatsapp_app/features/chat/presentation/widgets/message_widgets/message_type_widget.dart';
import 'package:whatsapp_app/features/user/presentation/cubit/get_single_user/get_single_user_cubit.dart';
    ...
    try {
      ...
      setState(() {
        if (pickedFile != null) {
          ...
          print("Aucune Image selectionner");
        }
      });
    } catch (e) {
      toast("Une erreur est survenu $e");
    }
  }
    ...
    try {
      ...
      setState(() {
        if (pickedFile != null) {
          ...
          print("Aucune video selectionner");
        }
      });
    } catch (e) {
      toast("Une erreur est survenu $e");
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        height: 40,
                                        decoration:
                                            BoxDecoration(color: appBarColor),
                                        child: Padding(
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    "${reply.username == widget.message.recipientName ? reply.username : "Vous"}",
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      color: reply.username ==
