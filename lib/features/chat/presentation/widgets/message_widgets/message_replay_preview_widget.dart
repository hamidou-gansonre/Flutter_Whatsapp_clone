        ...
        child: Row(
          children: [
            Container(
              ...
              width: 3.5,
              decoration: BoxDecoration(
                  color: provider.messageReplay.isMe == true ? tabColor : Colors
                      .deepPurpleAccent,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Expanded(child: Text("${provider.messageReplay.isMe ==
                            true ? "Vous" : provider.messageReplay.username}",
                          style: TextStyle(fontWeight: FontWeight.bold,
                              color: provider.messageReplay.isMe == true
                                  ? tabColor
                                  : Colors.deepPurpleAccent),)),
                        GestureDetector(onTap: onCancelReplayListener,
                            child: const Icon(
                              Icons.close, size: 18, color: greyColor,)),
                      ],
                    ),
                    const SizedBox(height: 3,),

                    provider.messageReplay.messageType ==
                        MessageTypeConst.textMessage ? Text(
                      "${provider.messageReplay.message}", maxLines: 2,
