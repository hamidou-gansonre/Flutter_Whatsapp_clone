    ...
    return Scaffold(
        ...
        body: Column(
          children: [
                    ...
                    return Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(
                                context, PageConst.editProfilePage, arguments: singleUser);
                          },
                          child: SizedBox(
                            width: 65,
                            height: 65,
                        ...
                        const SizedBox(width: 10),
                         Expanded(child: Column(
                          ...
                          children: [
                            Text("${singleUser.username}", style: const TextStyle(fontSize: 15),),
                            Text("${singleUser.status}", style: const TextStyle(
                                color: greyColor),),
                          ],
                        ),),
            ...
            _settingsItemWidget(
              title: "Chats",
              description: "Theme, wallpappers , chat history",
              icon: Icons.message,
              onTap: () {},
            ),
            _settingsItemWidget(
