...
import 'package:whatsapp_app/features/user/data/models/user_model.dart';
...
class UserRemoteDataSourceImpl implements UserRemoteDataSource {
  ...
  Future<void> verifyPhoneNumber(String phoneNumber) async {
    ...
    phoneVerificationCompleted(AuthCredential authCredential){
      print("Phone verification completed : Token ${authCredential.token} ${authCredential.signInMethod}");
    }

    phoneVerificationFailed(FirebaseAuthException firebaseAuthException){
      print("Phone verification failed :  ${firebaseAuthException.message} ${firebaseAuthException.code}");
    }

    phoneCodeAutoRetrievalTimeout(String verificationId){
      _verificationId = verificationId;
      print("Phone code auto retrieval timeout : $verificationId");
    }

    phoneCodeSent(String verificationId, int? forceResendingToken){
      _verificationId = verificationId;
      print("Phone code sent : $verificationId $forceResendingToken");
    }
